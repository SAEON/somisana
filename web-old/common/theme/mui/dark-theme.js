export default {
  ...
  components: {
    ...
    MuiButton: {
      ...
      styleOverrides: {},
      variants: [{ props: { variant: 'code' } }, { props: { variant: 'link' } }],
    },
    MuiIconButton: { variants: [{ props: { color: 'primary' } }] },
    MuiMenu: { styleOverrides: {} },
    MuiPopover: { styleOverrides: {} },
    MuiDivider: { styleOverrides: {} },
    MuiLink: {
    ...
    MuiTab: { defaultProps: { disableTouchRipple: true }, styleOverrides: {} },
    ...
    MuiPaginationItem: { styleOverrides: {} },
  },
  palette: {
    mode: 'light',
    primary: {
  ...
  typography: {
    ...
    allVariants: { scrollMarginTop: 'calc(var(--MuiDocs-header-height) + 72px)' },
    htmlFontSize: 16,
    fontSize: 14,
    fontWeightLight: 300,
