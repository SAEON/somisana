function make_OGCM_ocims_nest_ini(NY,NM,ND,RSTY,RSTM,RSTD,makeini)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% childgrid file must exist. The script creates a inital or restart 
% file depending on the vaiable makeini which is defined within the 
% forecast system. For now the script creates inital files for one 
% child but can be adapted in the future for more nests 
...
if makeini==1
	...
	%nested_initial(child_grd,parent_ini,child_ini,...
