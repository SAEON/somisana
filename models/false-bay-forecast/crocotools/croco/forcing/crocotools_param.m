...
%
CROCO_title  = 'False_bay_forecast';
CROCO_config = 'False_bay_forecast';
%
% Grid file generated by Delft3D
% (commented as we're not generating the grid in this folder)
%addpath(genpath('D:/CMC/Tools/openearthtools/matlab/applications/delft3d_matlab')) % path to delft3d openearth tools
%grdfile_d3d_uncut='../../../flow/algoa/grd_a/a_uncut.grd'; % we need the uncut grid as croco needs lon/lat to be defined everywhere
%grdfile_d3d='../../../flow/algoa/grd_a/a_.grd'; % we use the cut grid to define the croco mask
%depfile_d3d='na, as use_d3d_bathy = 0 below'; % note depth defined on the cut grid
%use_d3d_bathy=0; % use d3d depth (1) or create your own depth (0)
%
