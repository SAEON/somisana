...
#  elif defined  ST_HELENA_02
      parameter (LLm0=61,   MMm0=200,   N=50)   ! BENGUELA GGF nest
#  elif defined  ST_HELENA_2D_02
      parameter (LLm0=86,   MMm0=3,   N=50)   ! ST HELENA BAY SECTION, reduced extent
#  elif defined  ST_HELENA_2D_03
      parameter (LLm0=49,   MMm0=3,   N=100)   ! ST HELENA BAY SECTION, reduced extent
#  elif defined  ALGOA_02
      parameter (LLm0=150,   MMm0=104,   N=20)   ! ALGOA BAY CURVLINEAR GRID FROM Delft3D
#  elif defined  False_bay_forecast
      parameter (LLm0=80,   MMm0=48,   N=40)   ! False_Bay_forecast       
#  else
...
!
      ...
      parameter (NP_XI=3,  NP_ETA=4,  NNODES=NP_XI*NP_ETA)
      parameter (NPP=1)
