...
'''
This is the offical 'package' or script used to calculate mhw from (https://github.com/ecjoliver/marineHeatWaves)
No edits have been made.
The function detect requires a 1d array of sst and time and caculates mhw over the full period.
The function requires the full period of sst avaidable.
'''
