...
const Render = ({ map }) => {
  ...
  useEffect(() => {
    map.addSource('wms', {
      type: 'raster',
      tiles: [
        'https://thredds.somisana.ac.za/thredds/wms/data/somisana/sw-cape/5-day-forecast/202307/20230721-hourly-avg-t3.nc?REQUEST=GetMap&VERSION=1.3.0&LAYERS=temp&STYLES=default-scalar/default&PALETTE=default&BBOX={bbox-epsg-3857}&CRS=EPSG:3857&WIDTH=1024&HEIGHT=1024&FORMAT=image/png&transparent=true&elevation=200&time=2023-07-21T11:30:00.000Z',
      ],
      tileSize: 512,
    })
